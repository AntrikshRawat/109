...
function LocationsPage() {
  ...
  const { patients, dailyHistory, locations, addLocation, deleteLocation } = useAppStore()
  ...
  /* Check if a location is manually added (deletable) vs patient-derived */
  const isManualLocation = (name: string) => (locations || []).includes(name)
